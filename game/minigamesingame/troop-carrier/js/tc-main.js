...
function clickChoice(){
    ...
    switch(choice){
        case "tc-1":
            ...
            document.getElementById("tc-text-1").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-2":
            ...
            document.getElementById("tc-text-2").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-3":
            ...
            document.getElementById("tc-text-3").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-4":
            ...
            document.getElementById("tc-text-4").innerHTML += "<button class=\"minigamebutton\" id=\"software\" onClick=\"takeSoftware()\">Take the software</button><br><br>"
            document.getElementById("tc-text-4").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-5":
            ...
            document.getElementById("tc-text-5").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom();  addToClicks();\">Continue</button>";
            break;
        case "tc-6":
            ...
            document.getElementById("tc-text-6").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-7":
            ...
            document.getElementById("tc-text-7").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-8":
            ...
            document.getElementById("tc-text-8").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-9":
            ...
            document.getElementById("tc-text-9").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
        case "tc-10":
            ...
            document.getElementById("tc-text-10").innerHTML += "<button class=\"minigamebutton\" id=\"continue\" onClick=\"changeDom(); addToClicks();\">Continue</button>";
            break;
    }
